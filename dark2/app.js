 ...
 *   It can be observed in this manner: $(window).on('mouse-detected', function(event) { // custom code });
 *
 * - The touch-detected event is triggered on the window object when the user
 *   is using touch pointer input, or has switched from mouse to touch input.
 *   It can be observed in this manner: $(window).on('touch-detected', function(event) { // custom code });
 */
var PointerManager = {
...
var MenuManager = {
    ...
    wirePointerEvents: function() {
        var that = this;
        var pointerTarget = $('#nav a.dropdown-trigger');
        var hoverTarget = $('#nav li');
        ...
        if(PointerManager.getPointerEventsSupported()) {
            ...
            pointerTarget.on('touchend', function(e) {
                ...
                if($(this).data('was-touch')) { // Event invoked after touch
    ...
    PartialPointerEventsSupport: {
        ...
        mouseLeaveAction: function(event, target) {
            ...
            $(target).removeClass('menu-active'); //hide all menus
        },
...
$(document).ready(function () {
    ...
    preventMenuSpill();
    $(window).on('delayed-resize', preventMenuSpill);
    ...
    // Menu Trigger
    // =============================================
    $("#mainMenu-trigger button").click(function (e) {
...
*************************************************************/
    ...
    function appearAnim() {
        $('[has-anim="true"]').appear(function() {
            var $this = $(this);
                delay = $this.attr('data-delay');
            setTimeout( function(){
                $this.addClass('animOK');
            },delay + 300);
        },{accX: -100, accY: -90, one: false});
    }
